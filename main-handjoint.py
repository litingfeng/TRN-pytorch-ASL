...
from models import TSN, ContrastiveLoss, JointTSN
...
def initialize_model(num_class, args):
    model = JointTSN(num_class, args.num_segments, args.modality,
    ...
    train_augmentation = model.model.get_augmentation()
...
def train(train_loader, model, criterion, optimizer, epoch, log):
    ...
    for i, data in enumerate(train_loader):
        ...
        # compute output
        output, output_hand = model(input, input_hand)
